    ...
    return (
        <div
            ...
            <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0">
                <h2 className="text-skin-base text-base md:text-2xl text-underline mb-3 font-bold underline">
                    <AnimatedLetters strArray={name.split("")} idx={1} lettersClass={letterClass}> </AnimatedLetters>
                </h2>
                <p className="text-skin-base text-xs md:text-base">
                    <AnimatedLetters strArray={description.split("")} idx={1} lettersClass={letterClass}> </AnimatedLetters>
                </p>
                <a href="#Portfolio"
