...
export const About = () => {
  return (
    <section className="text-skin-base font-poppins m-10" id="About">
        <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center p-20">

            <h1 className="text-skin-base text-4xl font-semibold p-10 uppercase">
                Brief Introduction
            </h1>
            <svg xmlns="http://www.w3.org/2000/svg" fill="white" className="inline-block w-8 h-8 text-gray-400 mb-8"
            ...
            <p className="leading-relaxed text-lg">I am Javascript developer with great skills in customization of
                wix/editorX websites using Velo-Api.
